const genRules = (unit = 'px') => {
  return [
    ...
    // border
    { reg: /^bw(\d+)($|_.*)/, type:'border-width', to: 'border-width:$1' + unit },
    { reg: /^bbw(\d+)($|_.*)/, type:'border-bottom-width', to: 'border-bottom-width:$1' + unit },
    { reg: /^blw(\d+)($|_.*)/, type:'border-left-width', to: 'border-left-width:$1' + unit },
    { reg: /^brw(\d+)($|_.*)/, type:'border-right-width', to: 'border-right-width:$1' + unit },
    { reg: /^btw(\d+)($|_.*)/, type:'border-top-width', to: 'border-top-width:$1' + unit },
    { reg: /^bss($|_.*)/, type: 'border-style', to: 'border-style:solid' },
    { reg: /^bsd($|_.*)/, to: 'border-style:dashed' },
    { reg: /^bc(\w{3,8})($|_.*)/, type: 'border-color', to: 'border-color:#$1' },
