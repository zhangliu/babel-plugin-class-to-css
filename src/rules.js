...
const genRules = (unit = 'px') => {
  return [
    ...
    // margin
    { reg: /^m(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'margin:$1' + unit },
    { reg: /^mt(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'margin-top:$1' + unit },
    { reg: /^mb(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'margin-bottom:$1' + unit },
    { reg: /^ml(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'margin-left:$1' + unit },
    { reg: /^mr(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'margin-right:$1' + unit },

    { reg: /^mra($|_.*)/, to: 'margin-right:auto' },
    { reg: /^mla($|_.*)/, to: 'margin-left:auto' },

    // padding
    { reg: /^p(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'padding:$1' + unit },
    { reg: /^pt(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'padding-top:$1' + unit },
    { reg: /^pb(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'padding-bottom:$1' + unit },
    { reg: /^pl(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'padding-left:$1' + unit },
    { reg: /^pr(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'padding-right:$1' + unit },
    ...
    // font
    { reg: /^lh(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'line-height:$1' + unit },
    { reg: /^fwb($|_.*)/, to: 'font-weight:bold' },
    { reg: /^fs(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'font-size:$1' + unit },
    ...
    { reg: /^ls(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'letter-spacing: $1' + unit },
    ...
    { reg: /^t(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'top:$1' + unit },
    { reg: /^b(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'bottom:$1' + unit },
    { reg: /^l(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'left:$1' + unit },
    { reg: /^r(-?((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'right:$1' + unit },

    //width and height
    { reg: /^w(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'width:$1' + unit },
    { reg: /^w(\d+)b($|_.*)/, to: 'width:$1%' },
    { reg: /^miw(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'min-width:$1' + unit },
    { reg: /^maw(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'max-width:$1' + unit },

    { reg: /^h(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'height:$1' + unit },
    { reg: /^h(\d+)b($|_.*)/, to: 'height:$1%' },
    { reg: /^mih(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'min-height:$1' + unit },
    { reg: /^mah(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'max-height:$1' + unit },

    // border
    { reg: /^bw(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-width:$1' + unit },
    { reg: /^bbw(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-bottom-width:$1' + unit },
    { reg: /^blw(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-left-width:$1' + unit },
    { reg: /^brw(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-right-width:$1' + unit },
    { reg: /^btw(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-top-width:$1' + unit },
    { reg: /^bss($|_.*)/, to: 'border-style:solid' },
    { reg: /^bsd($|_.*)/, to: 'border-style:dashed' },
    { reg: /^bc(\w{3,8})($|_.*)/, to: 'border-color:#$1' },
    { reg: /^br(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-radius:$1' + unit },
    { reg: /^btlr(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-top-left-radius:$1' + unit },
    { reg: /^btrr(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-top-right-radius:$1' + unit },
    { reg: /^bbrr(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-bottom-right-radius:$1' + unit },
    { reg: /^bblr(((\d+)|(\.\d+)|(\d+\.\d+)))($|_.*)/, to: 'border-bottom-left-radius:$1' + unit },
